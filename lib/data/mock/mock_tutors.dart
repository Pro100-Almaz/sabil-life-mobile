...
final List<Tutor> mockTutors = [
  Tutor(
    ...
    subjects: [TutorSubject.math, TutorSubject.examPrep],
    formats: [
  ...
  Tutor(
    ...
    affiliationListingId: 'tutor-mathcraft',
    subjects: [TutorSubject.math, TutorSubject.science],
  ...
  Tutor(
    ...
    subjects: [TutorSubject.english, TutorSubject.examPrep],
